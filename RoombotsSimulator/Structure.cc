...
Structure::Structure(glm::vec3 position, int ID, Button* p_button) : _model("Shaders/module_vshader.glsl", "Shaders/module_fshader.glsl", ""),
                                                                     _shadow("Shaders/shadow_vshader.glsl", "Shaders/shadow_fshader.glsl", ""), 
																	 _position(position), 
																	 _ID(ID), 
																	 _p_button(p_button)
{
